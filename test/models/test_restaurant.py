...
class TestRestaurant(TestCase):
    ...
    def setUp(self):
        self.restaurant = Restaurant("Restaurante Delícia", "Comida Brasileira")

    def test_describe_restaurant(self):
        number_served = 100
        expected_description = "Esse restaurante chama Restaurante Delícia e serve Comida Brasileira."
    ...
    def test_open_restaurant(self):
        number_served = 0
        expected_output = "Restaurante Delícia agora está aberto!"
    ...
    def test_open_restaurant_already_open(self):
        ...
        number_served = 10
        expected_output = "Restaurante Delícia já está aberto!"
        output = self.restaurant.open_restaurant(number_served)
        self.assertEqual(output, expected_output)
    ...
    def test_close_restaurant(self):
        self.restaurant.open = True
        number_served = 0
        expected_output = "Restaurante Delícia agora está fechado!"
    ...
    def test_close_restaurant_closed(self):
        self.restaurant.open = False
        number_served = 1000
        expected_output = "Restaurante Delícia já está fechado!"
        output = self.restaurant.close_restaurant(number_served)
        self.assertEqual(output, expected_output)
    ...
    def test_set_number_served(self):
        total_customers = 100
        expected_output = "Restaurante Delícia já serviu 100 clientes até o momento!"
        output = self.restaurant.set_number_served(total_customers)
        self.assertEqual(output, expected_output)

    def test_set_number_served_close_restaurant(self):
        total_customers = 50
        expected_output = "Restaurante Delícia já serviu 50 clientes até o momento!"
        self.restaurant.open = False
        output = self.restaurant.set_number_served(total_customers)
        self.assertEqual(output, expected_output)
